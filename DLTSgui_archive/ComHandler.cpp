...
int ComHandler::ComOpen(unsigned Nr,int Baud,int Parity,int Stopbits,int Databits)
{
...
int	ComHandler::ComClose(unsigned Nr)
{
...
void ComHandler::ComDetectPorts(int &iCount,int *pMode,int iMaxPorts)
{
int		i;
char	cName[]="\\\\.\\COM1";
HANDLE	hCom;
...
int ComHandler::ComRead(unsigned Nr)
{
unsigned char 	c;
DWORD			dwCount;
...
int ComHandler::ComRead(unsigned Nr,void *Buffer,int Max)
{
DWORD	dwCount;
...
int ComHandler::ComWrite(unsigned Nr,int Zeichen)
{
DWORD			dwCount;
...
//	Ergibt die Anzahl der gesendeten Zeichen
int	ComHandler::ComWrite(unsigned Nr,void *Buffer,int Count)
{
DWORD			dwCount;
...
int ComHandler::ComGetReadCount(unsigned Nr)
{
COMSTAT		sComStat;
DWORD		dwErrorFlags;
...
//	Nr		: Ist die Nummer des Com-Ports (0=COM1 1=COM2 ...)
//	Ergibt die Anzahl der Bytes im Buffer
int ComHandler::ComGetWriteCount(unsigned Nr)
{
COMSTAT		sComStat;
DWORD		dwErrorFlags;
